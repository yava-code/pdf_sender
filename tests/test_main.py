...
class TestPDFSenderBot:
    ...
    def mock_dependencies(self):
        ...
        with patch('main.Bot') as mock_bot, \
             ...
             patch('main.PDFScheduler') as mock_scheduler:
    ...
    async def test_start_handler(self, pdf_bot, mock_message, mock_dependencies):
        ...
        mock_dependencies['db'].add_user.assert_called_once_with(
            12345, 'test_user'
        )
    ...
    @pytest.mark.asyncio
    async def test_goto_page_handler_valid(self, pdf_bot, mock_message, mock_dependencies):
    ...
    @pytest.mark.asyncio
    async def test_goto_page_handler_out_of_range(self, pdf_bot, mock_message, mock_dependencies):
    ...
    async def test_send_pages_to_user(self, pdf_bot, mock_dependencies):
        ...
        mock_dependencies['pdf_reader'].extract_pages_as_images.assert_called_once_with(1, 3)
