...
class TestPDFReader:
    ...
    def test_extract_pages_as_images(self, mock_get_total, mock_extract_page, pdf_reader):
    ...
    @patch('pdf_reader.PDFReader.extract_page_as_image')
    @patch('pdf_reader.PDFReader.get_total_pages')
    def test_extract_pages_beyond_total(self, mock_get_total, mock_extract_page, pdf_reader):
    ...
    def test_cleanup_images(self, pdf_reader):
        ...
        test_files = [
            ...
            "page_4.png", "page_5.png", "other_file.txt"
        ]
