...
class TestFileValidator(unittest.TestCase):
    ...
    def test_validate_pdf_file_valid(self):
        ...
        is_valid, message = FileValidator.validate_pdf_file(pdf_path)
    ...
    def test_validate_pdf_file_not_found(self):
        ...
        is_valid, message = FileValidator.validate_pdf_file("nonexistent.pdf")
    ...
    def test_validate_pdf_file_too_large(self):
        ...
        with patch("file_validator.Config.MAX_FILE_SIZE_MB", 1):  # 1MB limit
            is_valid, message = FileValidator.validate_pdf_file(pdf_path, file_size)
    ...
    def test_validate_pdf_file_empty(self):
        ...
        is_valid, message = FileValidator.validate_pdf_file(fake_pdf)
    ...
    def test_validate_pdf_file_too_many_pages(self):
        ...
        with patch("file_validator.os.path.exists", return_value=True), patch(
            ...
            is_valid, message = FileValidator.validate_pdf_file("fake.pdf")
    ...
    def test_validate_file_name_valid(self):
        ...
        is_valid, sanitized = FileValidator.validate_file_name("book.pdf")
    ...
    def test_validate_file_name_no_extension(self):
        ...
        is_valid, sanitized = FileValidator.validate_file_name("book")
    ...
    def test_validate_file_name_dangerous_chars(self):
        ...
        is_valid, sanitized = FileValidator.validate_file_name(
            "../../../etc/passwd.pdf"
        )
    ...
    def test_validate_file_name_too_long(self):
        ...
        long_name = "a" * 200 + ".pdf"
        is_valid, sanitized = FileValidator.validate_file_name(long_name)
